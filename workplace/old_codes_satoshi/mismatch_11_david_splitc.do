...
/* measure that includes current match */
bysort id occ: egen maxten_occ = max(tenure_occ)
by id: gen totmaxten = sum(maxten_occ)
if($twodim ==1){
	foreach i in "aa" "bb"{
		* for the current match, it gives the total number of years worker will be there:
		/*gen tmm_`i' = absmm_`i'*maxten_occ
		*gen tmatch_`i' = match_`i'*maxten_occ
		*by id: egen cmm_cur_`i' = total(tmm_`i')
		*replace cmm_cur_`i' = cmm_cur_`i'/totmaxten
		*by id: egen cmatch_cur_`i' = total(tmatch_`i')
		*replace cmatch_cur_`i' = cmatch_cur_`i'/totmaxten
		*/
		* for the current match, it only gives the number of years that has been there
		gen cmm_cur_`i'		= cmm_ave_`i' 	+ tenure_occ*absmm_`i'
		gen cmatch_cur_`i'	= cmatch_ave_`i'+ tenure_occ*match_`i'
* interact it with previous experience
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage match match_ten_occ cmatch_ave $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage mm mm_ten_occ cmm_ave $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/corrols_cq_q_asvab_onet.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons  replace
outreg2 using $result/apxtable_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se replace
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ  ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv ability_skill_mean_ten_occ_iv
...
xtset id year
global xlist mm_aveneg_ten_occ mm_avepos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_aveneg_ten_occ_iv mm_avepos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage mm_aveneg mm_avepos cmm_aveneg_ave cmm_avepos_ave ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, vce(robust)

xtset id year
global xlist mm_neg_ten_occ mm_pos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_neg_ten_occ_iv mm_pos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage mm_neg mm_pos cmm_neg_ave cmm_pos_ave ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, vce(robust)


xtset id year
global xlist mm_aveneg_ten_occ mm_avepos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_aveneg_ten_occ_iv mm_avepos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: xtivreg lwage mm_aveneg mm_avepos cmm_aveneg_ave cmm_avepos_ave ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d

xtset id year
global xlist mm_neg_ten_occ mm_pos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_neg_ten_occ_iv mm_pos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: xtivreg lwage mm_neg mm_pos cmm_neg_ave cmm_pos_ave ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, fe
*/
