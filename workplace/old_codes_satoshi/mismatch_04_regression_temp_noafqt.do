...
/*------------------------------------------------------------------------------------*/
/* mismatch with positive and negative components with tenure */
...
esttab iv_lpm_${diminitls}_mm iv_lpm_${diminitls}_mm_ind iv_lpm_${diminitls}_mm_pos_neg lpm_${diminitls}_mm lpm_${diminitls}_mm_ind lpm_${diminitls}_mm_pos_neg ///
		   ...
		   order(mm absmm_aa absmm_bb absmm_cc mm_pos mm_neg ability_mean ability_mean* skill_mean skill_mean*) drop(tenure_occ ten_occ2 tenure_emp ten_emp2 exp exp2 oj $zlist _cons _I* ) replace
...
esttab iv_lpm_${diminitls}_mm iv_lpm_${diminitls}_mm_ind iv_lpm_${diminitls}_mm_pos_neg lpm_${diminitls}_mm lpm_${diminitls}_mm_ind lpm_${diminitls}_mm_pos_neg ///
		   ...
		   order(mm absmm_aa absmm_bb absmm_cc mm_pos mm_neg ability_mean ability_mean* skill_mean skill_mean* tenure_occ ten_occ2 tenure_emp ten_emp2 exp exp2 oj $zlist) drop(_cons _I*) replace
/* tex */
esttab iv_lpm_${diminitls}_mm iv_lpm_${diminitls}_mm_ind iv_lpm_${diminitls}_mm_pos_neg lpm_${diminitls}_mm lpm_${diminitls}_mm_ind lpm_${diminitls}_mm_pos_neg ///
                   ...
                   "\sym{\sym{\dagger}}" "$^{\dagger}$" "\sym{\sym{*}}" "$^{*}$" "\sym{\sym{**}}" "$^{**}$") ///
		   mtitles("LPM-IV" "LPM-IV" "LPM-IV" "LPM" "LPM" "LPM") ///
		   order(mm absmm_aa absmm_bb absmm_cc mm_pos mm_neg ability_mean ability_mean* skill_mean skill_mean*) drop(tenure_occ ten_occ2 tenure_emp ten_emp2 exp exp2 oj $zlist _cons _I* ) ///
                   star(\sym{\dagger} 0.10 \sym{*} 0.05 \sym{**} 0.01) replace
...
esttab iv_lpm_${diminitls}_mm iv_lpm_${diminitls}_mm_ind iv_lpm_${diminitls}_mm_pos_neg lpm_${diminitls}_mm lpm_${diminitls}_mm_ind lpm_${diminitls}_mm_pos_neg ///
		   ...
		   mtitles("LPM-IV" "LPM-IV" "LPM-IV" "LPM" "LPM" "LPM") ///
		   title("Regressions for Probability of Occupational Switch (Full Results)") ///
		   order(mm absmm_aa absmm_bb absmm_cc mm_pos mm_neg ability_mean ability_mean* skill_mean skill_mean* tenure_occ ten_occ2 tenure_emp ten_emp2 exp exp2 oj $zlist) drop(_cons _I*) ///
                   star(\sym{\dagger} 0.10 \sym{*} 0.05 \sym{**} 0.01) replace
...
/*------------------------------------------------------------------------------------*/
/* figure of switching probability */
