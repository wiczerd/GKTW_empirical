...
xi: reg lwage mm $xlist $zlist ability_mean ability_mean2 skill_mean i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ols_mm_means.ster, replace

global xlist  ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
xi: ivregress 2sls lwage mm ($xlist = $ivlist) $zlist ability_mean ability_mean2 skill_mean i.ind_1d i.occ_1d , vce(robust)
...
global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg lwage mm cmm $xlist $zlist ability_mean ability_mean2 skill_mean i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ols_cmm_mm_means.ster, replace

global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist mm_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
xi: ivregress 2sls lwage mm cmm ($xlist = $ivlist) $zlist ability_mean ability_mean2 skill_mean i.ind_1d i.occ_1d, vce(robust)
