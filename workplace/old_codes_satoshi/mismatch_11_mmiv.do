...
xi: ivregress 2sls fswitch_occ mm_aa_neg mm_bb_neg mm_aa_pos  mm_bb_pos ( mm_cc_neg mm_cc_pos $prswlist_x = ${prswlist_iv} mm_h_iv_neg mm_h_iv_pos) $prswlist_z  if cmm_ave<. , vce(robust)
