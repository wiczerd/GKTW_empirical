...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage match match_ten_occ cmatch_exp $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage mm mm_ten_occ cmm_exp $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/corrols_cq_q_asvab_onet.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
...
xi: ivregress 2sls lwage match cmatch_exp ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
...
xi: ivregress 2sls lwage mm cmm_exp ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
...
xi: ivregress 2sls lwage match_?? cmatch_exp ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
...
xi: ivregress 2sls lwage absmm_?? cmm_exp ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)


* exclude cumulative measures
xtset id year
global xlist match_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
...
xtset id year
global xlist match_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_??_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage match_1 match_2 match_3 ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean i.ind_1d i.occ_1d, vce(robust)

xtset id year
global xlist mm_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_??_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage absmm_?? ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, vce(robust)
...
xi: ivregress 2sls lwage mm_aveneg mm_avepos cmm_aveneg_exp cmm_avepos_exp ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, vce(robust)
...
xi: ivregress 2sls lwage mm_neg mm_pos cmm_neg_exp cmm_pos_exp ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, vce(robust)


xtset id year
global xlist mm_aveneg_ten_occ mm_avepos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_aveneg_ten_occ_iv mm_avepos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: xtivreg lwage mm_aveneg mm_avepos cmm_aveneg_exp cmm_avepos_exp ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d

xtset id year
global xlist mm_neg_ten_occ mm_pos_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_neg_ten_occ_iv mm_pos_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: xtivreg lwage mm_neg mm_pos cmm_neg_exp cmm_pos_exp ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean  i.ind_1d i.occ_1d, fe
*/
