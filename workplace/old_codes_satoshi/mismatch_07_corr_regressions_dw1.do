...
by id: gen cmatch = (sum(lmatch) - lmatch)/nswitch if switch_occ==1 & nswitch >=2
by id: gen cmm    = (sum(lmm) - lmm)/nswitch if switch_occ==1  & nswitch >=2
by id: gen cmatch_exp = (sum(lmatch*lexp) - lmatch*lexp)/nswitch if switch_occ==1  & nswitch >=2
by id: gen cmm_exp = (sum(lmm*lexp) - lmm*lexp)/nswitch if switch_occ==1  & nswitch >=2
...
keep if $sample_select
xtset id year
xi: reg lwage match ASVAB_ONET_X sum_asvab_rnk sum_ONET_rnk $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
*	sortvar(match sum_asvab_rnk sum_ONET_rnk $xlist)
...
keep if $sample_select
xtset id year
xi: reg lwage match match_ten_occ  ASVAB_ONET_X   ASVAB_ONET_X_ten_occ sum_asvab_rnk asvab_ten_occ sum_ONET_rnk ONET_ten_occ $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
*	sortvar(match match_ten_occ sum_asvab_rnk asvab_ten_occ sum_ONET_rnk ONET_ten_occ $xlist)
...
outreg2 using $result/table_corrols.tex, bdec(3) tex(fragment) ctitle("", "(4)") drop(_I* $zlist) label se ///
	sortvar(match match_ten_occ match_ten_occ2 sum_asvab_rnk asvab_ten_occ asvab_ten_occ2 sum_ONET_rnk ONET_ten_occ ONET_ten_occ2 $xlist)*/
...
keep if $sample_select
xtset id year
xi: reg lwage match match_ten_occ  ASVAB_ONET_X  ASVAB_ONET_X_ten_occ sum_asvab_rnk asvab_ten_occ sum_ONET_rnk ONET_ten_occ cmatch cmatch_exp $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
*outreg2 using $result/table_corrols.tex, bdec(3) tex(fragment) ctitle("", "(4)") drop(_I* $zlist) label se ///
*	sortvar(match match_ten_occ sum_asvab_rnk asvab_ten_occ sum_ONET_rnk ONET_ten_occ cmatch cmatch_exp $xlist)
...
keep if $sample_select
xtset id year
xi: reg lwage mm sum_asvab_rnk sum_ONET_rnk $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv 
xi: ivregress 2sls lwage match  ASVAB_ONET_X sum_asvab_rnk sum_ONET_rnk ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
...
keep if $sample_select
xtset id year
global xlist match_ten_occ  ASVAB_ONET_X_ten_occ asvab_ten_occ ONET_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv  match_ten_occ_iv  ASVAB_ONET_X_ten_occ_iv asvab_ten_occ_iv ONET_ten_occ_iv
xi: ivregress 2sls lwage match  ASVAB_ONET_X sum_asvab_rnk sum_ONET_rnk  ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
...
keep if $sample_select
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_ten_occ2  ASVAB_ONET_X_ten_occ asvab_ten_occ ONET_ten_occ ONET_ten_occ2 asvab_ten_occ2  ASVAB_ONET_X_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv  match_ten_occ_iv match_ten_occ2_iv  ASVAB_ONET_X_ten_occ_iv  ASVAB_ONET_X_ten_occ2_iv asvab_ten_occ_iv ONET_ten_occ_iv ONET_ten_occ2_iv asvab_ten_occ2_iv
xi: ivregress 2sls lwage  ($xlist = $ivlist) match $zlist  ASVAB_ONET_X sum_ONET_rnk sum_asvab_rnk i.ind_1d i.occ_1d, vce(robust)
...
global xlist match_ten_occ  ASVAB_ONET_X_ten_occ asvab_ten_occ ONET_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv  ASVAB_ONET_X_ten_occ_iv asvab_ten_occ_iv ONET_ten_occ_iv 
qui xi: ivregress 2sls lwage match sum_ONET_rnk sum_asvab_rnk cmatch cmatch_exp ASVAB_ONET_X ($xlist = $ivlist) $zlist  i.ind_1d i.occ_1d , vce(robust)
