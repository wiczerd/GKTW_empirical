...
graph export ${result}/fig_mm_median_${diminitls}_rnk_exp.png, replace
...
legend(off) ///
graphregion(color(white)) xlabel(0(5)`max_exp',grid gstyle(default)) ylabel(, grid gstyle(default))
graph export ${result}/fig_mm_mean_${diminitls}_rnk_exp.png, replace
...
/* tex */		   
esttab iv_mm iv_mm_ten iv_cmm_mm ols_mm ols_mm_ten ols_cmm_mm ///
...
/* tex */
esttab iv_mm_pos_neg iv_mm_ten_pos_neg iv_cmm_mm_pos_neg ols_mm_pos_neg ols_mm_ten_pos_neg ols_cmm_mm_pos_neg ///
...
/* tex */
esttab iv_ind_mm iv_ind_mm_ten iv_ind_cmm_mm ols_ind_mm ols_ind_mm_ten ols_ind_cmm_mm ///
