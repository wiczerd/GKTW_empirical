...
replace inv_omega = inv_omega*inv_omega
...
global ivlist mm_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
if("${varcor}" == "cid" ){
	qui ivreg2 lwage mm cmm ($xlist = $ivlist)  skill_mean _Iind_1d_* _Iocc_1d_* i.id, cluster( id_job) fe
} 
else{
...
global ivlist mm_pos_ten_occ_iv mm_neg_ten_occ_iv $ivlist_0
if("${varcor}" == "cid" ){
	xtivreg2 lwage mm_pos mm_neg cmm_pos cmm_neg _Iind_1d* _Iocc_1d* ($xlist = $ivlist), cluster(id_job) fe
} 
else{
...
global ivlist absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv $ivlist_0
if("${varcor}"=="cid"){
	ivreg2 lwage cmm_aa cmm_bb cmm_cc absmm_?? ($xlist = $ivlist) skill_?? _Iind_1d* _Iocc_1d* i.id, cluster(id_job) fe
} 
else{
...
predict uhat, e
xtreg uhat l.uhat, fe /* mm cmm  $zlist ability_mean skill_mean i.ind_1d i.occ_1d ${xlist} */
global rhohat = _b["L.uhat"]
xtreg uhat l.uhat, fe /* mm cmm  $zlist ability_mean skill_mean i.ind_1d i.occ_1d ${xlist} */
predict inv_omega, xbu
replace inv_omega = inv_omega*inv_omega
