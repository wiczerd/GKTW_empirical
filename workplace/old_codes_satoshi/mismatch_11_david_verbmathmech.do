...
* control individual dimensions
xtset id year
global xlist match_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
xi: ivregress 2sls lwage match cmatch_ave ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)

xtset id year
global xlist mm_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_??_ten_occ skill_??_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
xi: ivregress 2sls lwage mm cmm_ave ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)

/*******************************************************/
** The regressions to output 
/*******************************************************/

* split individual dimensions
xtset id year
global xlist match_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
xi: ivregress 2sls lwage match_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
outreg2 using $result/regs_verbmath.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se replace sortvar(match_?? $xlist $zlist )

global xlist absmm_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_??_ten_occ skill_??_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv
xi: ivregress 2sls lwage absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
outreg2 using $result/regs_verbmath.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se sortvar(match_* absmm_?? $xlist $zlist )

* split individual dimensions (include ability X skill)
xtset id year
global xlist match_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage match_?? ($xlist = $ivlist) $zlist ability_?? skill_?? ability_skill_mean i.ind_1d i.occ_1d , vce(robust)
outreg2 using $result/regs_verbmath_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se replace

xtset id year
global xlist absmm_??_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_??_ten_occ skill_??_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? ability_skill_mean i.ind_1d i.occ_1d, vce(robust)
outreg2 using $result/regs_verbmath_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match_* absmm_?? $xlist $zlist)


* with cumulative measures and cumulative * experience
xtset id year
global xlist cmatch_??_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ
global ivlist cmatch_??_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
xi: ivregress 2sls lwage cmatch_cur_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
outreg2 using $result/regs_verbmath.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se sortvar(match_* absmm_* cmatch_* $xlist $zlist)

xtset id year
global xlist cmm_??_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_??_ten_occ skill_??_ten_occ
global ivlist cmm_??_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv
xi: ivregress 2sls lwage cmm_cur_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
outreg2 using $result/regs_verbmath.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match_* absmm_* cmatch_* cmm_* $xlist $zlist)

*  with cumulative measures and cumulative * experience (include ability X skill)
xtset id year
global xlist cmatch_??_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ  ability_skill_mean_ten_occ
global ivlist cmatch_??_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage cmatch_cur_?? ($xlist = $ivlist) $zlist ability_?? skill_??  ability_skill_mean i.ind_1d i.occ_1d , vce(robust)
outreg2 using $result/regs_verbmath_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se sortvar(match_* absmm_* cmatch_* $xlist $zlist)

xtset id year
global xlist cmm_??_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_??_ten_occ skill_??_ten_occ  ability_skill_mean_ten_occ
global ivlist cmm_??_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_??_ten_occ_iv skill_??_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage cmm_cur_?? ($xlist = $ivlist) $zlist ability_?? skill_??  ability_skill_mean i.ind_1d i.occ_1d, vce(robust)  
outreg2 using $result/regs_verbmath_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match_* absmm_* cmatch_* cmm_* $xlist $zlist)

/* NOW DO IT WHEN DIMENSIONS ARE TOGETHER */

*global xlist match_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_??_ten_occ skill_??_ten_occ
*global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv 
*xi: ivregress 2sls lwage match ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
*outreg2 using $result/regs_vmtogether.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se replace  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist)
...
outreg2 using $result/regs_vmtogether.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist)
...
outreg2 using $result/regs_vmtogether_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist) replace

xtset id year
global xlist mm_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ ability_skill_mean_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
xi: ivregress 2sls lwage mm ($xlist = $ivlist) $zlist ability_mean skill_mean ability_skill_mean i.ind_1d i.occ_1d, vce(robust)
outreg2 using $result/regs_vmtogether_as.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist)


* with cumulative measures and cumulative * experience
xtset id year
global xlist  cmatch_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_mean_ten_occ skill_mean_ten_occ
global ivlist cmatch_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv 
xi: ivregress 2sls lwage cmatch_cur ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d , vce(robust)
outreg2 using $result/regs_vmtogether.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist)

xtset id year
global xlist  cmm_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ
global ivlist cmm_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv 
xi: ivregress 2sls lwage cmm_cur ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
outreg2 using $result/regs_vmtogether.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se  sortvar(match* mm* cmatch_* cmm_* $xlist $zlist)

*  with cumulative measures and cumulative * experience (include ability X skill)
xtset id year
global xlist  cmatch_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj ability_mean_ten_occ skill_mean_ten_occ  ability_skill_mean_ten_occ
global ivlist cmatch_exp_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv
...
xtset id year
global xlist cmm_exp tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  ability_mean_ten_occ skill_mean_ten_occ  ability_skill_mean_ten_occ 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv ability_skill_mean_ten_occ_iv cmm_exp_iv
