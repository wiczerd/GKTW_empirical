...
set more off
use $data/ern_yearly_02.dta, clear
...
/* generate annual earnings */
replace inc_salary = 0   if inc_salary == .   | inc_salary < 0
replace inc_farm_biz = 0 if inc_farm_biz == . | inc_farm_biz < 0

gen earn = inc_salary + inc_farm_biz
...
/* selection by real earnings, if in top 0.1% or in bottom 0.1% (disabled) */
forvalues i = 1/24 {
_pctile rearn if intvw_num == `i', p(0.1, 99.9)
drop if rearn <= r(r1) & intvw_num == `i'
drop if rearn >= r(r2) & intvw_num == `i'
}
...
save $data/ern_yearly_03.dta, replace
...
use $data/ern_yearly_03.dta, clear
...
by occ_part: egen learn_occ_iv = mean(learn)
replace learn_occ_iv = learn - learn_occ_iv 
by occ_part: egen learn_occ2_iv = mean(learn^2)
replace learn_occ2_iv = learn^2 - learn_occ2_iv 
...
xi: reg learn $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
xi: ivregress 2sls learn ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d , vce(robust)
...
xi: reg learn mm $xlist $zlist ability_mean skill_mean i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ols_mm_means.ster, replace

global xlist  ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
xi: ivregress 2sls learn mm ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d , vce(robust)
...
global xlist  $xlist_0
xi: reg learn mm_pos mm_neg $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ols_mm_means_pos_neg.ster, replace

global xlist  $xlist_0
global ivlist $ivlist_0
xi: ivregress 2sls learn mm_pos mm_neg ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d , vce(robust)
...
global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg learn mm cmm $xlist $zlist ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ols_cmm_mm_means.ster, replace

global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist mm_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
xi: ivregress 2sls learn mm cmm ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
...
global xlist  mm_pos_ten_occ mm_neg_ten_occ $xlist_0
xi: reg learn mm_pos mm_neg cmm_pos cmm_neg $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ols_cmm_mm_means_pos_neg.ster, replace

global xlist  mm_pos_ten_occ mm_neg_ten_occ $xlist_0
global ivlist mm_pos_ten_occ_iv mm_neg_ten_occ_iv $ivlist_0
xi: ivregress 2sls learn mm_pos mm_neg cmm_pos cmm_neg ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
...
xi: reg learn absmm_?? $xlist $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ols_ind_mm_means.ster, replace

global xlist  ability_??_ten_occ skill_??_ten_occ $xlist_0
global ivlist ability_??_ten_occ_iv skill_??_ten_occ_iv $ivlist_0
xi: ivregress 2sls learn absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d , vce(robust)
...
global xlist  absmm_??_ten_occ ability_??_ten_occ skill_??_ten_occ $xlist_0 
global ivlist absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv $ivlist_0
xi: ivregress 2sls learn cmm_aa cmm_bb cmm_cc absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
