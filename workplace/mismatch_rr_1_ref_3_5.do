...
/* for referees */
/*------------------------------------------------------------------------------------*/
/* all-dimensional mismatch */


global xlist  ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg lwage mm_dim $xlist $zlist ability_mean skill_mean i.ind_1d i.occ_1d
predict uhat, residuals
reg uhat l.uhat, noc /*, fe  */
global rhohat = _b["L.uhat"]
drop uhat
qui forvalues iter=1/50{
	qui foreach zv of varlist mm_dim $zlist ability_mean skill_mean $xlist lwage{
		gen `zv'_R =`zv'
		replace `zv'= `zv'_R  - ${rhohat}*l.`zv'_R 
		_crcslbl `zv'_R `zv'
	}
...
global xlist  ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
ivregress 2sls lwage mm_dim ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d
predict uhat, residuals
reg uhat l.uhat, noc /*, fe  */
global rhohat = _b["L.uhat"]
drop uhat
qui forvalues iter=1/50{
	qui foreach zv of varlist mm_dim $zlist ability_mean skill_mean $xlist $ivlist lwage{
		gen `zv'_R =`zv'
		replace `zv'= `zv'_R  - ${rhohat}*l.`zv'_R 
		_crcslbl `zv'_R `zv'
	}
	xi: ivregress 2sls lwage mm_dim ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d
...
global xlist  mm_dim_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg lwage mm cmm_dim $xlist $zlist ability_mean skill_mean i.ind_1d i.occ_1d
predict uhat, residuals
reg uhat l.uhat, noc /*, fe  */
global rhohat = _b["L.uhat"]
drop uhat
qui forvalues iter=1/50{
	...
	xi: reg lwage mm_dim cmm_dim $xlist $zlist ability_mean skill_mean i.ind_1d i.occ_1d
	estimate save ${result}/ols_cmm_mm_means.ster, replace
	predict uhat, residuals
	reg uhat l.uhat, noc /*, fe  */
	if( abs( _b["L.uhat"] - ${rhohat})<0.01 ){
...
global xlist  mm_dim_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
global ivlist mm_dim_ten_occ_iv ability_mean_ten_occ_iv skill_mean_ten_occ_iv $ivlist_0
ivregress 2sls lwage mm_dim cmm_dim ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d
predict uhat, residuals
reg uhat l.uhat, noc /*, fe  */
global rhohat = _b["L.uhat"]
drop uhat
qui forvalues iter=1/50{
	qui foreach zv of varlist mm_dim cmm_dim $zlist ability_mean skill_mean $xlist $ivlist lwage{
		gen `zv'_R =`zv'
		replace `zv'= `zv'_R  - ${rhohat}*l.`zv'_R 
		_crcslbl `zv'_R `zv'
	}
	xi: ivregress 2sls lwage mm_dim cmm_dim ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d
