...
global xlist  absmm_??_ten_occ ability_??_ten_occ skill_??_ten_occ $xlist_0 
xi: ivreg2 lwage cmm_aa cmm_bb cmm_cc cmm_dd absmm_?? $xlist $zlist ability_?? skill_?? i.ind_1d i.occ_1d, bw(2) robust
estimate save ${result}/ols_ind_cmm_mm_means.ster, replace

global xlist  absmm_??_ten_occ ability_??_ten_occ skill_??_ten_occ $xlist_0 
global ivlist absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv $ivlist_0
xi: ivreg2 lwage cmm_aa cmm_bb cmm_cc cmm_dd absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, bw(2) robust
