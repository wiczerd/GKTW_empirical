...
/* this code runs the regressions.  It implelments the nl2sls by applying the function */ 
...
/*
qui foreach cmmv of varlist cmm cmm_neg cmm_pos cmm_?? cmm_neg_?? cmm_pos_?? {
	reg `cmmv' ${hlth_list} ${zlist}, vce(robust)
	predict `cmmv'_iv
}
*/
...
label var cmm_iv "Cumul Mismatch"
label var cmm_pos_iv "Cumul Mismatch Positive"
label var cmm_neg_iv "Cumul Mismatch Negative"
...
global xlist  mm_ten_occ mm
global ivlist mm_iv_ten_occ mm_iv
...
global xlist  mm_pos_ten_occ mm_neg_ten_occ mm_pos mm_neg 
global ivlist mm_pos_iv_ten_occ mm_neg_iv_ten_occ mm_pos_iv mm_neg_iv 
xi: ivregress 2sls lwage ($xlist = $ivlist) $xlist_0 $zlist ability_mean skill_mean ability_mean_ten_occ skill_mean_ten_occ i.ind_1d i.occ_1d , vce(robust)
...
global ivist mm_iv cmm_iv mm_iv_ten_occ
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist $xlist_0 ability_mean skill_mean ability_mean_ten_occ skill_mean_ten_occ i.ind_1d i.occ_1d, vce(robust)
...
global xlist  mm_neg mm_pos mm_pos_iv_ten_occ mm_neg_iv_ten_occ cmm_pos cmm_neg $xlist_0 ability_mean_ten_occ skill_mean_ten_occ
global ivlist mm_neg_iv mm_pos_iv mm_pos_iv_ten_occ_iv mm_neg_iv_ten_occ_iv cmm_pos_iv cmm_neg_iv $ivlist_0 ability_mean_ten_occ_iv skill_mean_ten_occ_iv
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
...
global xlist absmm_cc absmm_cc_ten_occ ability_cc
global ivlist absmm_h_iv absmm_h_iv_ten_occ ability_h_iv
xi: ivregress 2sls lwage ($xlist = $ivlist) absmm_aa absmm_bb absmm_aa_ten_occ absmm_bb_ten_occ  $zlist $xlist_0 ability_aa ability_bb skill_?? /*
	*/ ability_aa_ten_occ ability_bb_ten_occ ability_h_iv_ten_occ skill_??_ten_occ i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ivh_ind_mm_means.ster, replace

global xlist absmm_cc absmm_aa_ten_occ absmm_bb_ten_occ absmm_cc_ten_occ $xlist_0 /*
	*/ ability_aa_ten_occ ability_bb_ten_occ ability_cc_ten_occ skill_??_ten_occ ability_cc
global ivlist absmm_h_iv absmm_aa_ten_occ_iv absmm_bb_ten_occ_iv absmm_h_iv_ten_occ_iv ability_h_iv $ivlist_0 /* 
	*/ ability_aa_ten_occ_iv ability_bb_ten_occ_iv ability_h_iv_ten_occ_iv skill_??_ten_occ_iv 
xi: ivregress 2sls lwage absmm_aa absmm_bb ($xlist = $ivlist) $zlist ability_aa ability_bb  skill_?? i.ind_1d i.occ_1d , vce(robust)
...
global ivlist cmm_h_iv absmm_h_iv absmm_h_iv_ten_occ 
global xlist cmm_cc absmm_cc absmm_cc_ten_occ 
xi: ivregress 2sls lwage ($xlist = $ivlist) cmm_aa absmm_aa cmm_bb absmm_bb absmm_aa_ten_occ absmm_bb_ten_occ $zlist $xlist_0 ability_aa ability_bb ability_h_iv skill_?? ability_??_ten_occ skill_??_ten_occ i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ivh_ind_cmm_mm_means.ster, replace

global xlist  cmm_cc absmm_cc absmm_aa_ten_occ absmm_bb_ten_occ absmm_cc_ten_occ $xlist_0 ability_cc ability_??_ten_occ skill_??_ten_occ
global ivlist cmm_h_iv absmm_h_iv absmm_aa_ten_occ_iv absmm_bb_ten_occ_iv absmm_h_iv_ten_occ_iv $ivlist_0 ability_h_iv ability_??_ten_occ_iv skill_??_ten_occ_iv
xi: ivregress 2sls lwage ($xlist = $ivlist) cmm_aa absmm_aa cmm_bb absmm_bb $zlist ability_aa ability_bb skill_?? i.ind_1d i.occ_1d, vce(robust)
...
global xlist  absmm_??_ten_occ ability_??_ten_occ skill_??_ten_occ $xlist_0 
global ivlist absmm_??_ten_occ_iv ability_??_ten_occ_iv skill_??_ten_occ_iv $ivlist_0
xi: ivregress 2sls lwage cmm_?? absmm_?? ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/iv_ind_cmm_mm_means.ster, replace
*/
...
//////////////////////////////
/* ability times experience
global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg lwage mm $xlist $zlist ability_exp ability_mean skill_mean i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ols_mm_means_abilexp.ster, replace

global xlist  mm mm_ten_occ
global ivlist mm_iv mm_iv_ten_occ
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist $xlist_0 ability_exp ability_mean skill_mean ability_mean_ten_occ skill_mean_ten_occ i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/ivh_mm_means_abilexp.ster, replace

global xlist  mm mm_ten_occ $xlist_0 ability_mean_ten_occ skill_mean_ten_occ
global ivlist mm_iv mm_iv_ten_occ_iv $ivlist_0 ability_mean_ten_occ_iv skill_mean_ten_occ_iv 
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist ability_exp ability_mean skill_mean i.ind_1d i.occ_1d , vce(robust)
estimate save ${result}/iv_mm_means_abilexp.ster, replace

global xlist  mm_ten_occ ability_mean_ten_occ skill_mean_ten_occ $xlist_0
xi: reg lwage mm cmm $xlist $zlist ability_exp ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ols_cmm_mm_means_abilexp.ster, replace

global xlist  mm cmm mm_ten_occ
global ivlist mm_iv cmm_iv mm_iv_ten_occ
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist $xlist_0 ability_exp ability_mean skill_mean ability_mean_ten_occ skill_mean_ten_occ i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ivh_cmm_mm_means_abilexp.ster, replace

global xlist  mm cmm mm_ten_occ $xlist_0 ability_mean_ten_occ skill_mean_ten_occ
global ivlist mm_iv cmm_iv mm_iv_ten_occ_iv $ivlist_0 ability_mean_ten_occ_iv skill_mean_ten_occ_iv
xi: ivregress 2sls lwage ($xlist = $ivlist) $zlist ability_exp ability_mean skill_mean i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/iv_cmm_mm_means_abilexp.ster, replace
 */
/*------------------------------------------------------------------------------------*/
/* creating tables */
...
//////////////////////////////
///// additional table 1 /////                                                                                                                                                                                                                                 /* check later */
//////////////////////////////
esttab iv_cmm_mm_means_pos_neg ivh_cmm_mm_means_pos_neg ols_cmm_mm_means_pos_neg  ///
...
estimate clear
estimate use ${result}/ols_mm_means_abilexp.ster
estimate store ols_mm_means_abilexp
estimate use ${result}/ols_cmm_mm_means_abilexp.ster
estimate store ols_cmm_mm_means_abilexp

estimate use ${result}/ivh_mm_means_abilexp.ster
estimate store ivh_mm_means_abilexp
estimate use ${result}/ivh_cmm_mm_means_abilexp.ster
estimate store ivh_cmm_mm_means_abilexp

estimate use ${result}/iv_mm_means_abilexp.ster
estimate store iv_mm_means_abilexp
estimate use ${result}/iv_cmm_mm_means_abilexp.ster
estimate store iv_cmm_mm_means_abilexp

esttab iv_mm_means_abilexp iv_cmm_mm_means_abilexp ivh_mm_means_abilexp ivh_cmm_mm_means_abilexp ols_mm_means_abilexp ols_cmm_mm_means_abilexp ///
                   using ${result}/table_apx_${diminitls}_abilexp.tex, b(4) se(4) ///
                   r2 nodepvars nogaps label longtable substitute(\hline\hline \hline \hline "\noalign{\vskip 1mm} \hline \noalign{\vskip 1mm}" ///
		   "Standard errors in parentheses" "All regressions include occupation and industry dummies." ///
		   "\sym{\sym{\dagger}} \(p<0.10\), \sym{\sym{*}} \(p<0.05\), \sym{\sym{**}} \(p<0.01\)" "Robust standard errors in parentheses. \sym{\sym{\dagger}} \(p<0.10\), \sym{\sym{*}} \(p<0.05\), \sym{\sym{**}} \(p<0.01\)." ///
                   "\sym{\sym{\dagger}}" "$^{\dagger}$" "\sym{\sym{*}}" "$^{*}$" "\sym{\sym{**}}" "$^{**}$") ///
		   title("Wage Regression with Ability $\times$ Experience (Full Results)") ///
		   drop(_I*) ///
		   mtitles("IV: TH" "IV: TH" "IV: H" "IV: H" "OLS" "OLS") ///
		   order(mm mm_ten_occ cmm ability_mean ability_mean_ten_occ ability_exp skill_mean skill_mean_ten_occ ten* exp* oj $zlist _cons) ///
                   star(\sym{\dagger} 0.10 \sym{*} 0.05 \sym{**} 0.01) replace
...
esttab iv_ind_mm_means iv_ind_cmm_mm_means ivh_ind_mm_means ivh_ind_cmm_mm_means ols_ind_mm_means ols_ind_cmm_mm_means ///
		   ...
		   mtitles("IV: TH" "IV: TH" "IV: H" "IV: H" "OLS" "OLS") ///
		   order(absmm_aa absmm_bb absmm_cc absmm_aa_t* absmm_bb_t*  absmm_cc_t* cmm_aa cmm_bbcmm_cc ability_?? ability_??_* skill_?? skill_??_*) replace
...
estimate save ${result}/iv_lpm_${diminitls}_mm_sgn.ster, replace
...
estimate use ${result}/iv_lpm_${diminitls}_mm_sgn.ster
estimate store iv_lpm_${diminitls}_mm_sgn
/*
...
//////////////////////////////
esttab iv_lpm_${diminitls}_mm_sgn ivh_lpm_${diminitls}_mm_sgn lpm_${diminitls}_mm_sgn ///
