...
outreg2 using $result/apxtable_physols.tex, bdec(3) tex(fragment) ctitle("", "Benchmark") drop(_I* ) label se replace sortvar( $xlist)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage cmatch_exp cmatch_phys_exp $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physols_cq_cpq.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) sortvar(cmatch_exp cmatch_phys_exp) label se replace nocons
outreg2 using $result/apxtable_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) sortvar(cmatch_exp cmatch_phys_exp $xlist $zlist) label se append
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage match match_ten_occ match_phys match_phys_ten_occ $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physols_q_pq.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons append ///
	sortvar(match_ten_occ match match_phys_ten_occ match_phys)
outreg2 using $result/apxtable_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se append ///
	sortvar(match_ten_occ match  match_phys_ten_occ match_phys $xlist $zlist) 
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage cmatch_exp match match_ten_occ cmatch_phys_exp match_phys match_phys_ten_occ $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physols_cq_q_cpq_pq.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
	sortvar(cmatch_exp cmatch_phys_exp match_ten_occ match match_phys_ten_occ match_phys)
outreg2 using $result/apxtable_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmatch_exp cmatch_phys_exp match_ten_occ match match_phys_ten_occ match_phys $xlist $zlist )
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage cmatch_exp match match_ten_occ ASVAB_ONET_X   ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ///
	cmatch_phys_exp match_phys match_phys_ten_occ ONET_phys_pca hlth_comp_i ///
	$xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physols_cq_q_cpq_pq_asvab_onet.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
	sortvar(cmatch_exp cmatch_phys_exp match_ten_occ match match_phys_ten_occ match_phys ////
	ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ONET_phys_pca hlth_comp_i)
outreg2 using $result/apxtable_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmatch_exp cmatch_phys_exp match_ten_occ match match_phys_ten_occ match_phys ////
	ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ONET_phys_pca hlth_comp_i $xlist $zlist )

/* ols with cum match + match + (asvab +onet + asvab_X_onet)(1+tenure) (WITHOUT PHYSICAL ATTRIBUTES) */
...
estimate save $result/physols_cq_q_asvab_onet.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* $zlist)  varlabels se replace
outreg2 using $result/table_physols.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
...
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", "Benchmark") drop(_I* ) label se replace sortvar( $xlist) 
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
xi: reg lwage cmm_exp cmm_phys_exp $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_cmm.ster, replace
*outreg , merge tex bdec(3) ctitle("", "(1)") drop(_I* $zlist )  fragment varlabels se replace
outreg2 using $result/table_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se replace nocons ///
	sortvar(cmm_exp cmm_phys_exp )
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp cmm_phys_exp  $xlist $zlist)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
qui xi: reg lwage mm mm_ten_occ mm_phys_ten_occ mm_phys $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_mm.ster, replace
*outreg , merge tex bdec(3) ctitle("", "(1)") drop(_I* $zlist )  fragment varlabels se replace
outreg2 using $result/table_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
	sortvar(mm_ten_occ mm mm_phys_ten_occ mm_phys )
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(mm_ten_occ mm mm_phys_ten_occ mm_phys $xlist $zlist)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
qui xi: reg lwage cmm_exp  mm mm_ten_occ cmm_phys_exp mm_phys_ten_occ mm_phys  $xlist $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_cmm_mm.ster, replace
*outreg , merge tex bdec(3) ctitle("", "(1)") drop(_I* $zlist )  fragment varlabels se replace
outreg2 using $result/table_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
	sortvar(cmm_exp cmm_phys_exp mm_ten_occ mm mm_phys_ten_occ mm_phys  )
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp cmm_phys_exp mm_ten_occ mm mm_phys_ten_occ mm_phys $xlist $zlist)
...
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
qui xi: reg lwage cmm_exp  mm mm_ten_occ ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ///
	cmm_phys_exp mm_phys_ten_occ mm_phys  ONET_phys_pca hlth_comp_i ///
	$xlist $zlist i.ind_1d i.occ_1d, vce(robust)
...
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp cmm_phys_exp mm_ten_occ mm mm_phys_ten_occ mm_phys ///
	ASVAB_ONET_X   ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ $xlist $zlist)


/* ols with cum mismatch + mismatch + (asvab +onet + asvab_X_onet)(1+tenure) (NO HEALTH )*/
use $result/yearly_03_phys.dta, clear
keep if $sample_select
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
...
outreg2 using $result/apxtable_physols_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp  mm_ten_occ mm ASVAB_ONET_X   ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ  ONET_phys_pca hlth_comp_i $xlist $zlist)
...
outreg2 using $result/apxtable_physiv.tex, bdec(3) tex(fragment) ctitle("", "Benchmark") ///
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv
xi: ivregress 2sls lwage cmatch_exp cmatch_phys_exp ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physiv_cq.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") drop(_I* $zlist ) fragment varlabels se
outreg2 using $result/table_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $xlist $zlist) label se nocons ///
	sortvar(cmatch_exp) replace
outreg2 using $result/apxtable_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
...
keep if $sample_select
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_phys_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_phys_ten_occ_iv
qui xi: ivregress 2sls lwage match match_phys ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physiv_q.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") drop(_I* $zlist ) fragment varlabels se
outreg2 using $result/table_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ten* exp* oj $zlist) label se nocons ///
	sortvar(match_ten_occ match match_phys_ten_occ match_phys)
outreg2 using $result/apxtable_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(match_ten_occ match match_phys_ten_occ match_phys ten* exp* oj $zlist)
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_phys_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_phys_ten_occ_iv
qui xi: ivregress 2sls lwage cmatch_exp match cmatch_phys_exp match_phys ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physiv_cq_q.ster, replace
*outreg, tex merge bdec(3) ctitle("", "(1)") drop(_I* $zlist ) fragment varlabels se
outreg2 using $result/table_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ten* exp* oj $zlist) label se nocons ///
...
keep if $sample_select
xtset id year
global xlist match_ten_occ  ASVAB_ONET_X_ten_occ asvab_m_ten_occ ONET_m_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_phys_ten_occ 
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv  match_ten_occ_iv  ASVAB_ONET_X_ten_occ_iv asvab_m_ten_occ_iv ONET_m_ten_occ_iv match_phys_ten_occ_iv
xi: ivregress 2sls lwage cmatch_exp match cmatch_phys_exp match_phys ASVAB_ONET_X asvab_m ONET_m  ONET_phys_pca hlth_comp_i ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/physiv_cq_q_asvab_onet.ster, replace
...
outreg2 using $result/apxtable_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se ///
	sortvar(cmatch_exp cmatch_phys_exp match_ten_occ match match_phys_ten_occ match_phys ////
	ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ONET_phys_pca hlth_comp_i ten* exp* oj $zlist)

/* IV with match + sum of ONET score + ONET * occ_ternure + sum of ASVABV score + ASVAB * occ_ternure (No health!) */
...
*outreg , tex merge bdec(3) ctitle("", "(3)") drop(_I* $zlist ) fragment varlabels se replace
outreg2 using $result/table_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ten* exp* oj $zlist) label se nocons ///
	sortvar(cmatch_exp match_ten_occ match asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ASVAB_ONET_X ASVAB_ONET_X_ten_occ)
outreg2 using $result/apxtable_physiv.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* ) label se ///
...
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", "Benchmark")  ///
...
global xlist  tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv
xi: ivregress 2sls lwage cmm_exp cmm_phys_exp ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/iv_cmm.ster, replace
*outreg, merge tex bdec(3) ctitle("", "(1)") drop(_I* $zlist ) fragment varlabels se
outreg2 using $result/table_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I* $zlist $xlist) label se ///
	sortvar(cmm_exp cmm_phys_exp) nocons replace
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp  cmm_phys_exp ten* exp* oj $zlist)
...
keep if $sample_select
xtset id year
global xlist  tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj mm_ten_occ mm_phys_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv mm_phys_ten_occ_iv
xi: ivregress 2sls lwage mm mm_phys ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/iv_mm.ster, replace
*outreg, merge tex bdec(3) ctitle("", "(1)") drop(_I* $zlist ) fragment varlabels se
outreg2 using $result/table_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") label se  nocons ///
	sortvar(mm_ten_occ mm mm_phys_ten_occ mm_phys ) ///
	drop(_I* $zlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj)
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(mm_ten_occ mm mm_phys_ten_occ mm_phys ten* exp* oj $zlist)
...
global xlist  tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj mm_ten_occ mm_phys_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv mm_phys_ten_occ_iv
xi: ivregress 2sls lwage cmm_exp mm cmm_phys_exp mm_phys ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
...
outreg2 using $result/table_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") label se nocons ///
	...
	drop(_I* $zlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj)
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ") drop(_I*) label se ///
	sortvar(cmm_exp cmm_phys_exp mm_ten_occ mm mm_phys_ten_occ mm_phys ten* exp* oj $zlist)
...
keep if $sample_select
xtset id year
global xlist mm_ten_occ  ASVAB_ONET_X_ten_occ asvab_m_ten_occ ONET_m_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj mm_phys_ten_occ
global ivlist mm_ten_occ_iv ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv  ASVAB_ONET_X_ten_occ_iv asvab_m_ten_occ_iv ONET_m_ten_occ_iv mm_phys_ten_occ_iv
xi: ivregress 2sls lwage cmm_exp mm cmm_phys_exp mm_phys asvab_m ONET_m  ONET_phys_pca hlth_comp_i ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
...
outreg2 using $result/table_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ")  label se nocons ///
	...
	ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ONET_phys_pca hlth_comp_i) ///
	drop(_I* $zlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj)
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ")  label se drop(_I*) ///
	sortvar(cmm_exp cmm_phys_exp mm_ten_occ mm mm_phys_ten_occ mm_phys ///
	ASVAB_ONET_X  ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ONET_phys_pca hlth_comp_i ///
...
/* IV with mismatch + sum of ONET score + ONET * occ_ternure + sum of ASVABV score + ASVAB * occ_ternure (NO HEALTH)*/
...
xi: ivregress 2sls lwage cmm_exp mm asvab_m ONET_m ($xlist = $ivlist) $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/iv_cmm_mm_asvab_onet.ster, replace
*outreg , tex merge bdec(3) ctitle("", "(3)") drop(_I* $zlist ) fragment varlabels se replace
outreg2 using $result/table_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ")  label se nocons ///
	sortvar(cmm_exp mm_ten_occ mm asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ ) ///
	drop(_I* $zlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj)
outreg2 using $result/apxtable_physiv_mm.tex, bdec(3) tex(fragment) ctitle("", " ")  label se drop(_I*) ///
	sortvar(cmm_exp mm_ten_occ mm ASVAB_ONET_X_ten_occ ASVAB_ONET_X_ten_occ asvab_m asvab_m_ten_occ ONET_m ONET_m_ten_occ tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj $zlist) 


xi: ivregress 2sls lwage ($xlist = $ivlist) mm cmm_exp $zlist  sum_ONET_rnk sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
...
clear
estimate use $result/physols_q.ster
matrix eb=e(b)
...
estimate use $result/physiv_q.ster
matrix eb=e(b)
matrix marg_match = J(16,4,0.0)
forvalues tt=0/15{
	matrix marg_match[`tt'+1,1] = `tt'
...
graph export $result/marg_effect_physols_iv.eps, replace
...
lpattern("_" "-" "_-" ) ///
legend(label(1 "+1 Standard Dev") label(2 "Mean") label(3 "-1 Standard Deviation") ) ///
saving($result/marg_effect_physols_mm, replace)
graph export $result/marg_effect_physols_mm.eps, replace
drop marg_match*
...
lpattern("_" "-" "_-" ) ///
legend(label(1 "+1 Standard Dev") label(2 "Mean") label(3 "-1 Standard Deviation") ) ///
saving($result/marg_effect_physiv_mm, replace)
graph export $result/marg_effect_physiv_mm.eps, replace
drop marg_match*

graph combine $result/marg_effect_physols_mm.gph $result/marg_effect_physiv_mm.gph, ycommon
graph export $result/marg_effect_physols_physiv_mm.eps, replace
...
lpattern("l" "_" "_-" "_--" "--") ///
legend(label(1 "90 pctl") label(2 "50 pctl") label(3 "10 pctl")) ///
...
graph export $result/pred_effect_physols_iv.eps, replace
...
lpattern("l" "_" "_-" "_--" "--") ///
legend(label(1 "90 pctl") label(2 "50 pctl") label(3 "10 pctl")) ///
saving($result/pred_effect_physols_mm, replace)
graph export $result/pred_effect_physols_mm.eps, replace
drop pred_match*
...
forvalues tt=0/15{
	matrix pred_match[`tt'+1,1] = `tt'
*	matrix pred_match[`tt'+1,2] = _b["mm"]*`p90'+_b["mm_ten_occ"]*`p90'*`tt' 
*	matrix pred_match[`tt'+1,3] = _b["mm"]*`p70'+_b["mm_ten_occ"]*`p70'*`tt' 
*	matrix pred_match[`tt'+1,4] = _b["mm"]*`p50'+_b["mm_ten_occ"]*`p50'*`tt' 
*	matrix pred_match[`tt'+1,5] = _b["mm"]*`p30'+_b["mm_ten_occ"]*`p30'*`tt' 
*	matrix pred_match[`tt'+1,6] = _b["mm"]*`p10'+_b["mm_ten_occ"]*`p10'*`tt' 
	matrix pred_match[`tt'+1,2] = _b["mm"]*`p90'+_b["mm_ten_occ"]*`p90'*`tt' 
	matrix pred_match[`tt'+1,3] = _b["mm"]*`p50'+_b["mm_ten_occ"]*`p50'*`tt' 
	matrix pred_match[`tt'+1,4] = _b["mm"]*`p10'+_b["mm_ten_occ"]*`p10'*`tt'
}
...
lpattern("l" "_" "_-" "_--" "--") ///
legend(label(1 "90 pctl") label(2 "50 pctl") label(3 "10 pctl")) ///
saving($result/pred_effect_physiv_mm, replace)
graph export $result/pred_effect_physiv_mm.eps, replace
drop pred_match*

graph combine $result/pred_effect_physols_mm.gph $result/pred_effect_physiv_mm.gph, ycommon
graph export $result/pred_effect_physols_physiv_mm.eps, replace

/*------------------------------------------------------------------------------------*/
/*-----------------------Distribution of cmm, cmatch effect---------------------------*/

use $result/yearly_03_phys.dta, clear
estimate use $result/physiv_cq_q.ster
...
forvalues i=1/`Nind'{
	...
	matrix ind_match[`i',4] = r(mean)
}
*	qui sum match 
*	matrix ind_match[`Nind'+1,1]  = r(mean)
*	matrix ind_match[`Nind'+1,2]  = r(sd)
*	_pctile match , p(10 50 90)
*	matrix ind_match[`Nind'+1,3]  = (r(r3) - 2*r(r2) +r(r1) )/(r(r3)-r(r1) )
...
sum ind_1d, meanonly
local Nind = r(max)
matrix ind_cmatch = J(`Nind',4,0.0)
