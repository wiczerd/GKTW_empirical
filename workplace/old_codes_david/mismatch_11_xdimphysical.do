...
if ${hlth_idx_use}==0{
	global ivlist_0 $ivlist_0 $hlth_list
}
...
* mismatch iv	
	...
	estimate use ${result}/iv_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_*) drop(_I* oj ten* exp* $zlist) replace
	outreg2 using ${result}/apxtable_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* ) replace

	estimate use ${result}/iv_cmm_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_ave_* cmm_*_ave ability* skill* ) drop(_I* oj ten* exp* $zlist) 
	outreg2 using ${result}/apxtable_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_ave_* cmm_*_ave ability* skill* ten* exp* oj $zlist) drop(_I* ) 

	estimate use ${result}/iv_cmm_mm_means_pos_neg.ster
	outreg2 using ${result}/table_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ) drop(_I* oj ten* exp* $zlist)
	outreg2 using ${result}/apxtable_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* )

	estimate use ${result}/iv_ind_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave cmm_ave_*  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ) drop(_I* oj ten* exp* $zlist) 
	outreg2 using ${result}/apxtable_${diminitls}_mm_comp.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mm mm_ten* mm_pos mm_neg mm_pos_* mm_neg_* absmm_?? absmm_??_ten* cmm_ave cmm_*_ave cmm_ave_*  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* ) 
...
* mismatch ols
	...
	outreg2 using ${result}/table_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_*  absmm_* cmm_ave cmm_*_ave  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_*) drop(_I* oj ten* exp* $zlist) replace
	outreg2 using ${result}/apxtable_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_*  absmm_* cmm_ave cmm_*_ave  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* ) replace

	estimate use ${result}/ols_cmm_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_*  absmm_* cmm_ave cmm_ave_* cmm_*_ave ability* skill* ) drop(_I* oj ten* exp* $zlist) 
	...
	outreg2 using ${result}/table_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_* absmm_* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ) drop(_I* oj ten* exp* $zlist)
	outreg2 using ${result}/apxtable_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) ctitle("", " ") label stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_* absmm_* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* )

	estimate use ${result}/ols_ind_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mmm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_* absmm_* cmm_ave cmm_*_ave cmm_ave_*  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ) drop(_I* oj ten* exp* $zlist) 
	outreg2 using ${result}/apxtable_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_* absmm_* cmm_ave cmm_*_ave cmm_ave_*  ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* ) 

	estimate use ${result}/ols_ind_cmm_mm_means.ster
	outreg2 using ${result}/table_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_* absmm_* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ) drop(_I* oj ten* exp* $zlist)
	outreg2 using ${result}/apxtable_${diminitls}_mm_ols.tex, bdec(3) tex(fragment) label ctitle("", " ") stats(coef) sortvar(mm mm_ten* mm_pos mm_neg  mm_pos_* mm_neg_*  absmm_* cmm_ave cmm_*_ave cmm_ave_* ability_mean* ability_?? ability_??_* skill_mean* skill_?? skill_??_* ten* exp* oj $zlist) drop(_I* )	
...
use ${result}/yearly_03_phys_${diminitls}.dta, clear
xtset id year
global zlist bmi_init_p25 bmi_init_m25 bmi_init2 height yob bdad_alive bdad_death bmom_alive bmom_death $zlist_0
...
/* iv lpm regressions */
xi: ivregress 2sls fswitch_occ mm (${prswlist_x} = ${prswlist_iv} ) $prswlist_z if cmm_ave<. , vce(robust)
estimate save ${result}/ivlpm_${diminitls}_mm.ster, replace
xi: ivregress 2sls fswitch_occ mm_neg mm_pos (${prswlist_x} = ${prswlist_iv}) $prswlist_z  if cmm_ave<. , vce(robust)
estimate save ${result}/ivlpm_${diminitls}_mm_sgn.ster, replace

xi: ivregress 2sls fswitch_occ mm_??_neg mm_??_pos ($prswlist_x = ${prswlist_iv}) $prswlist_z  if cmm_ave<. , vce(robust)
estimate save ${result}/ivlpm_${diminitls}_mm_ind_sgn.ster, replace
xi: ivregress 2sls fswitch_occ absmm_?? ($prswlist_x = ${prswlist_iv}) $prswlist_z  if cmm_ave<. , vce(robust)
estimate save ${result}/ivlpm_${diminitls}_mm_ind.ster, replace

/* setup residuals */

qui foreach mvar of varlist mm mm_neg mm_pos fswitch_occ{
	ivregress 2sls `mvar'   (${prswlist_x} = ${prswlist_iv} ) $prswlist_z if cmm_ave<.
...
twoway (lpoly fswitch_occ mm_neg, lwidth(thick)) (lpoly fswitch_occ mm_pos, lwidth(thick))  if cmm_ave<. , ///
...
twoway (lpoly fswitch_occ mm, lwidth(thick) )  if cmm_ave<. , ///
ytitle("Probability of Occupational Switch") ///
xtitle("Mismatch") ///
title("Probability of Occupational Switch") ///
legend(off) ///
...
if($verbmathphys == 1){
	...
	/* switch rate by negative/positive mismatch */
	twoway (lpoly fswitch_occ mm_aa_neg, lwidth(thick)) (lpoly fswitch_occ mm_aa_pos, lwidth(thick)) ///
	(lpoly fswitch_occ mm_bb_neg, lwidth(thick)) (lpoly fswitch_occ mm_bb_pos, lwidth(thick)) ///
	(lpoly fswitch_occ mm_cc_neg, lwidth(thick)) (lpoly fswitch_occ mm_cc_pos, lwidth(thick)), ///
	ytitle("Probability of Occupational Switch") ///
	xtitle("Mismatch") ///
	title("Probability of Occupational Switch") ///
	legend(lab(1 "Verbal Mismatch") lab(2 "Verbal Mismatch") lab(3 "Math Mismatch") lab(4 "Math Mismatch") ///
		lab(5 "Physical Mismatch") lab(6 "Physical Mismatch") ring(0) pos(6) cols(2)) ///
	graphregion(color(white)) xlabel(,grid gstyle(dot)) ylabel(,grid gstyle(dot)) ///
	saving(${result}/pswitch_mm, replace)
