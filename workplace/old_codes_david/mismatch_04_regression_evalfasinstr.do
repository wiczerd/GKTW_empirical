...
/* this code runs the regressions.  It implelments the nl2sls by applying the function 
   and uses that as the instruments*/ 
...
global xlist absmm_cc absmm_aa_ten_occ absmm_bb_ten_occ absmm_cc_ten_occ $xlist_0 ability_??_ten_occ skill_??_ten_occ
...
xi: ivregress 2sls lwage cmm_aa absmm_aa cmm_bb absmm_bb absmm_aa_ten_occ absmm_bb_ten_occ ($xlist = $ivlist) $zlist $xlist_0 ability_?? skill_?? ability_??_ten_occ skill_??_ten_occ i.ind_1d i.occ_1d, vce(robust)
estimate save ${result}/ivh_ind_cmm_mm_means.ster, replace

global xlist  cmm_cc absmm_cc absmm_??_ten_occ $xlist_0 ability_??_ten_occ skill_??_ten_occ
global ivlist cmm_h_iv absmm_h_iv absmm_aa_ten_occ_iv absmm_bb_ten_occ_iv absmm_h_iv_ten_occ_iv $ivlist_0 ability_??_ten_occ_iv skill_??_ten_occ_iv
xi: ivregress 2sls lwage cmm_aa absmm_aa cmm_bb absmm_bb ($xlist = $ivlist) $zlist ability_?? skill_?? i.ind_1d i.occ_1d, vce(robust)
