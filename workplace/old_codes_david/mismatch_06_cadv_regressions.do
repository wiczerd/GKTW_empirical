/*--------------------------------------------------------------------------------------
* name: mismatch_06_cadv_regression.do
...
forvalues i=1/7{
	qui gen asvab_cadv`i' = 0.
	forvalues j=1/7{
		qui replace asvab_cadv`i' = (asvab_rnk`i' >=asvab_rnk`j') + asvab_cadv`i'
	}
	replace asvab_cadv`i' = asvab_cadv`i'/7.
}
...
forvalues i=1/7{
	qui gen ONET_cadv`i' = 0.
	forvalues j=1/7{
		qui replace ONET_cadv`i' = (ONET_rnk_`i' >=ONET_rnk_`j') + ONET_cadv`i'
	}
	qui replace ONET_cadv`i' = ONET_cadv`i'/7.
}
...
forvalues i = 1/7 {
	...
	quietly replace match_cadv = match_cadv + asvab_cadv`i'*ONET_cadv`i'
}
...
forvalues i=1/7{
	quietly gen rnk_mismatch`i' =    (asvab_cadv`i'- ONET_cadv`i')
	quietly gen abs_mismatch`i' = abs(asvab_cadv`i'- ONET_cadv`i')
}
...
save $result/yearly_03_cadv.dta, replace
...
use $result/yearly_03_cadv.dta, clear
...
estimate save $result/cadvols.ster, replace
outreg, tex merge bdec(3) ctitle("", "(1)") fragment drop(_I* )  varlabels se replace
...
estimate save $result/cadvols_asvab.ster, replace
...
estimate save $result/cadvols_asvab_occ.ster, replace
...
estimate save $result/cadvols_ONET.ster, replace
...
estimate save $result/cadvols_ONET_occ.ster, replace
outreg using $result/table_cadvols.tex, tex merge bdec(3) ctitle("", "(5)") fragment drop(_I* ) varlabels se replace
...
estimate save $result/cadvols_mm.ster, replace
...
estimate save $result/cadvols_asvab_mm.ster, replace
outreg , tex merge bdec(3) ctitle("", "(2)") drop(_I* ) fragment varlabels se replace
...
estimate save $result/cadvols_asvab_occ_mm.ster, replace
...
estimate save $result/cadvols_ONET_mm.ster, replace
...
estimate save $result/cadvols_ONET_occ_mm.ster, replace
outreg using $result/table_cadvols_mm.tex, tex merge bdec(3) fragment ctitle("", "(5)") drop(_I* ) varlabels se replace
...
estimate save $result/cadviv.ster, replace
...
estimate save $result/cadviv_asvab.ster, replace
...
xi: ivregress 2sls lwage ($xlist = $ivlist) match $zlist sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
estimate save $result/cadviv_asvab_occ.ster, replace
...
estimate save $result/cadviv_ONET.ster, replace
...
xi: ivregress 2sls lwage ($xlist = $ivlist) match $zlist sum_ONET_rnk i.ind_1d i.occ_1d , vce(robust)
estimate save $result/cadviv_ONET_occ.ster, replace
outreg using $result/table_cadviv.tex, tex merge bdec(3) fragment ctitle("", "(5)") drop(_I* ) varlabels se replace
...
estimate save $result/cadviv_mm.ster, replace
...
estimate save $result/cadviv_asvab_mm.ster, replace
outreg, tex merge bdec(3) fragment ctitle("", "(2)") drop(_I* ) varlabels se replace
...
xi: ivregress 2sls lwage ($xlist = $ivlist) mm $zlist sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
estimate save $result/cadviv_asvab_occ_mm.ster, replace
outreg, tex merge bdec(3) fragment ctitle("", "(3)") drop(_I* ) varlabels se replace
...
estimate save $result/cadviv_ONET_mm.ster, replace
outreg, tex merge bdec(3) fragment ctitle("", "(4)") drop(_I* ) varlabels se replace
...
xi: ivregress 2sls lwage ($xlist = $ivlist) mm $zlist sum_ONET_rnk i.ind_1d i.occ_1d , vce(robust)
estimate save $result/cadviv_ONET_occ_mm.ster, replace
outreg using $result/table_cadviv_mm.tex, tex merge bdec(3) fragment ctitle("", "(5)") drop(_I* ) varlabels se replace
