...
outreg using $result/table_ols.tex, tex merge bdec(3) ctitle("", "(3)") fragment drop(_I* $zlist ) varlabels se replace

/*------------------------------------------------------------------------------------*/

/* ols with match + sum of ONET score + ONET * occ_ternure + sum of ASVAB score + ASVAB * occ_ternure */

use $result/yearly_03.dta, clear
keep if $sample_select
xtset id year
xi: reg lwage $xlist match match_ten_occ match_ten_occ2 $zlist sum_ONET_rnk ONET_ten_occ sum_asvab_rnk asvab_ten_occ i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_ONET_ASVAB.ster, replace
*outreg using $result/table_ols.tex, tex merge bdec(3) ctitle("", "(3)") fragment drop(_I* $zlist ) varlabels se replace
...
keep if $sample_select
xtset id year
xi: reg lwage $xlist match match_ten_occ match_ten_occ2  cmatch cmatch_exp $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_cmatch.ster, replace
outreg using $result/table_ols.tex, tex merge bdec(3) ctitle("", "(4)") fragment drop(_I* $zlist ) varlabels se replace
...
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2 $zlist sum_asvab_rnk i.ind_1d i.occ_1d, vce(robust)
...
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2 $zlist sum_asvab_rnk asvab_ten_occ i.ind_1d i.occ_1d, vce(robust)
...
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2 $zlist sum_ONET_rnk i.ind_1d i.occ_1d, vce(robust)
...
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2 $zlist sum_ONET_rnk ONET_ten_occ i.ind_1d i.occ_1d, vce(robust)
...
/* ols with mismatch + sum of ONET score + ONET * occ_ternure + sum of ASVAB score + ONET * occ_ternure */

use $result/yearly_03.dta, clear
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2 $zlist sum_ONET_rnk ONET_ten_occ sum_asvab_rnk asvab_ten_occ  i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_ONET_ASVAB_mm.ster, replace
*outreg, tex merge bdec(3) fragment ctitle("", "(3)") drop(_I* $zlist ) varlabels se replace
...
keep if $sample_select
xtset id year
qui xi: reg lwage $xlist mm mm_ten_occ mm_ten_occ2  cmm cmm_exp $zlist i.ind_1d i.occ_1d, vce(robust)
estimate save $result/ols_cmm.ster, replace
outreg using $result/table_ols_mm.tex, tex merge bdec(3) ctitle("", "(4)") fragment drop(_I* $zlist ) varlabels se replace
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) match $zlist sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) match $zlist sum_ONET_rnk i.ind_1d i.occ_1d , vce(robust)
...
/* IV regression with match + sum of ONET score + ONET * occ_ternure  + sum of ASVAB score + ASVAB * occ_ternure */
/**/
use $result/yearly_03.dta, clear
keep if $sample_select
xtset id year
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_ten_occ2 ONET_ten_occ asvab_ten_occ
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_ten_occ2_iv ONET_ten_occ_iv asvab_ten_occ_iv
xi: ivregress 2sls lwage ($xlist = $ivlist) match $zlist sum_ONET_rnk sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
*estimate save $result/iv_ONET_ASVAB_occ.ster, replace
*outreg, tex merge bdec(3) fragment ctitle("", "(4)") drop(_I* $zlist ) varlabels se replace
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj match_ten_occ match_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv match_ten_occ_iv match_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) match cmatch cmatch_exp $zlist i.ind_1d i.occ_1d , vce(robust)
estimate save $result/iv_cmatch.ster, replace
outreg using $result/table_iv.tex, tex merge bdec(3) fragment ctitle("", "(4)") drop(_I* $zlist ) varlabels se replace
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj mm_ten_occ mm_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv mm_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) mm $zlist sum_asvab_rnk i.ind_1d i.occ_1d , vce(robust)
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  mm_ten_occ mm_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv mm_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) mm $zlist sum_ONET_rnk i.ind_1d i.occ_1d , vce(robust)
...
outreg using $result/table_iv_mm.tex, tex merge bdec(3) fragment ctitle("", "(3)") drop(_I* $zlist ) varlabels se replace
...
global xlist tenure_emp ten_emp2 tenure_occ ten_occ2 ten_occ3 exp exp2 exp3 oj  mm_ten_occ mm_ten_occ2
global ivlist ten_emp_iv ten_emp2_iv ten_occ_iv ten_occ2_iv ten_occ3_iv exp_iv exp2_iv exp3_iv oj_iv mm_ten_occ_iv mm_ten_occ2_iv
qui xi: ivregress 2sls lwage ($xlist = $ivlist) mm cmm cmm_exp $zlist i.ind_1d i.occ_1d , vce(robust)
estimate save $result/iv_cmm_mm.ster, replace
outreg using $result/table_iv_mm.tex, tex merge bdec(3) fragment ctitle("", "(4)") drop(_I* $zlist ) varlabels se replace
